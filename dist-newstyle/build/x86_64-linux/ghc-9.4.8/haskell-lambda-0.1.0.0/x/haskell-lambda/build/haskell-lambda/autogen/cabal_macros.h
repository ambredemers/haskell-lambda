...
/* package haskell-lambda-0.1.0.0 */
#ifndef VERSION_haskell_lambda
#define VERSION_haskell_lambda "0.1.0.0"
#endif /* VERSION_haskell_lambda */
#ifndef MIN_VERSION_haskell_lambda
#define MIN_VERSION_haskell_lambda(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_lambda */
...
#define CURRENT_COMPONENT_ID "haskell-lambda-0.1.0.0-inplace-haskell-lambda"
